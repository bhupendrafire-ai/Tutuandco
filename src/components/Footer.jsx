...
const Footer = () => {
    ...
    return (
        <footer className="bg-brand-cream border-t border-brand-charcoal/10 py-24">
            ...
            <div className="max-w-7xl mx-auto px-6 mt-24 pt-8 border-t border-brand-charcoal/10 flex flex-col md:flex-row justify-between items-center text-[11px] text-brand-charcoal/60 font-medium">
