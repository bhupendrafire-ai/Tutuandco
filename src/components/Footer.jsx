...
const Footer = () => {
    ...
    return (
        <footer className="bg-brand-cream border-t border-brand-charcoal/10 section-footer">
            <div className="page-container">
                <div className="content-wrap grid grid-cols-1 md:grid-cols-4 gap-16">
            ...
            <div className="page-container mt-24">
                <div className="content-wrap pt-8 border-t border-brand-charcoal/10 flex flex-col md:flex-row justify-between items-center text-[11px] text-brand-charcoal/60 font-medium">
