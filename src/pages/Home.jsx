...
const Home = () => {
    ...
    return (
        <div className="pb-20 bg-brand-sage">
            ...
            <div className="max-w-[1440px] mx-auto pt-10 px-3">
                ...
                <AnimatePresence mode="wait">
                    {activeBanner && (
                        ...
                        >
                            ...
                            <div className="w-full md:w-[35%] bg-[#7C846C] p-12 md:pt-[60px] md:pb-[60px] md:pr-[60px] md:pl-[40px] flex flex-col justify-center min-h-[350px] md:min-h-0 text-white">
        ...
        <section className="max-w-[1440px] mx-auto px-3 mt-28">
            ...
            <section className="py-20 bg-white">
                <div className="max-w-[1440px] mx-auto px-3 text-center flex flex-col items-center">
