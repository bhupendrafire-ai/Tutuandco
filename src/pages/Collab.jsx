            ...
            <div className="max-w-7xl mx-auto px-6">
                <header className="text-center mb-32">
                    <div className="flex flex-col items-center mb-6">
                        ...
                        <span className="uppercase tracking-[0.4em] text-[10px] font-medium text-brand-charcoal opacity-60">Creative</span>
                    </div>
                ...
                <div className="space-y-32">
                    ...
                    <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div>
                            <span className="text-[10px] uppercase tracking-widest text-brand-charcoal opacity-60 font-medium mb-4 block">Spring 2024 Collection</span>
                            ...
                            <button className="bg-brand-charcoal text-white px-12 py-5 text-[10px] font-medium uppercase tracking-widest hover:bg-brand-charcoal/80 transition-all shadow-lg">
                                Shop the Collab
                            </button>
                        </div>
                    </section>
                    ...
                    <section className="bg-brand-cream/80 backdrop-blur-sm py-32 px-10 text-center rounded-sm shadow-sm">
                        ...
                        <a 
                            ...
                            className="inline-flex items-center space-x-4 bg-white border border-brand-charcoal/10 px-12 py-6 text-[10px] font-medium uppercase tracking-[0.3em] text-brand-charcoal hover:bg-brand-charcoal hover:text-white transition-all group"
                        >
                            <Mail size={16} />
