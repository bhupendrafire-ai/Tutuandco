            ...
            <div className="max-w-[1440px] mx-auto px-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-20 mb-32">
                        ...
                        <section>
                            <div className="flex items-center mb-6">
                                <div className="w-10 h-10 bg-brand-cream rounded-full flex items-center justify-center mr-4 shadow-sm">
                                    <span className="font-medium text-brand-charcoal">1</span>
                                </div>
                                <h3 className="text-xl font-medium text-brand-charcoal">How to measure</h3>
                            </div>
                    ...
                    <div className="bg-brand-cream/80 backdrop-blur-sm p-10 rounded-sm shadow-sm">
                        <div className="flex items-center text-brand-charcoal opacity-60 mb-8 font-medium text-[11px]">
                            <Info size={16} className="mr-2" />
                            Sizing advice
                        </div>
                        <p className="text-brand-charcoal text-lg leading-relaxed mb-8">
                ...
                <section className="mb-32">
                    <h2 className="text-3xl font-medium text-brand-charcoal mb-12">Size chart</h2>
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-brand-charcoal/10 text-[11px] font-medium text-brand-charcoal opacity-40 uppercase">
                            ...
                            <tbody className="divide-y divide-brand-charcoal/5">
                                {[
                                    ...
                                    <tr key={i} className="text-brand-charcoal/70 hover:bg-brand-cream/50 transition-colors">
                                        <td className="py-6 pr-6 font-medium text-brand-charcoal">{row.size}</td>
                ...
                {/* Pet Guides */}
                <section>
                    <h2 className="text-4xl font-medium text-brand-charcoal mb-12">Find your pet’s size</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-brand-cream p-8 rounded-sm shadow-sm border border-brand-charcoal/5">
                            <h4 className="text-xl font-medium text-brand-charcoal mb-4">Small (s)</h4>
                        ...
                        <div className="bg-brand-cream p-8 rounded-sm shadow-sm border border-brand-charcoal/5">
                            <h4 className="text-xl font-medium text-brand-charcoal mb-4">Medium (m)</h4>
                            <p className="text-brand-charcoal/70 text-sm leading-relaxed">
                    ...
                    <p className="mt-8 text-[11px] text-brand-charcoal/40 font-medium tracking-wide text-center">
