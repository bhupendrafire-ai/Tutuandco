        ...
        <div className="bg-brand-sage min-h-screen pt-32 pb-32">
            <div className="max-w-5xl mx-auto px-6">
                <header className="mb-20">
                    <span className="uppercase tracking-[0.3em] text-[10px] font-medium text-brand-charcoal opacity-60 mb-6 block">Fitting Guide</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-20 mb-32">
                        ...
                        <section>
                            <div className="flex items-center mb-6">
                                <div className="w-10 h-10 bg-brand-cream rounded-full flex items-center justify-center mr-4 shadow-sm">
                                    <span className="font-serif font-medium text-brand-charcoal">1</span>
                                </div>
                                <h3 className="text-xl font-medium text-brand-charcoal uppercase tracking-wider">How to Measure</h3>
                            </div>
                    ...
                    <div className="bg-brand-cream/80 backdrop-blur-sm p-10 rounded-sm shadow-sm">
                        <div className="flex items-center text-brand-charcoal opacity-60 mb-8 font-medium text-[10px] uppercase tracking-[0.2em]">
                ...
                <section className="mb-32">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-brand-charcoal/10 text-[10px] uppercase font-medium text-brand-charcoal opacity-60 tracking-widest">
